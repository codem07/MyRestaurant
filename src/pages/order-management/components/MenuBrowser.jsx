...
const MenuBrowser = ({ onItemSelect, selectedItems, className = '' }) => {
  ...
  useEffect(() => {
    ...
    // Mock menu items with Indian cuisine
    const mockMenuItems = [
      {
        id: 'MI001',
      ...
      <div className="p-4">
        {filteredItems.length > 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <h4 className="text-lg font-semibold text-foreground mt-4">No items found</h4>
